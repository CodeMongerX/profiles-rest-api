...
class UserProfileManager(BaseUserManager):
    ...
    def createSuperUser(self, email, name, password):
        """ Create and saves a new superuser with details."""

        # create a normal user and add super user attributes & save.
...
# custom userprofile below


class userProfile(AbstractBaseUser, PermissionsMixin):
    """Represent a user profile in system."""
